  ...
  <ul class="slides">
    <li>
      ...
      <div class="caption center-align">
        ...
        <h5 class="light grey-text text-lighten-3">Tecnología Fotovoltáica a tu alcance.</h5>
      </div>
    </li>
    <li>
    ...
    <li>
      <img src="img/productos/fffoto.jpg">
      <div class="caption right-align">
        <h3>AUTOENERGY SPA</h3>
        <h5 class="light grey-text text-lighten-3">Sistemas electrónicos de potencia</h5>
      </div>
    </li>
    <li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col s5 m5 left-align">
            <b>Todos los derechos reservados a </b><a class="grey-text text-darken-4" href="index.html"><br><b>AutoEnergy Ingeniería y Servicios SPA</b></a> 
          </div>
